...
import {buttonClass, Button, Card, CardTitle, ClubHeader, Cover, ErrorBanner, Page, Subhead, TextArea} from '../components/ui'
...
export function HistoryPage() {
    ...
    return (
        <Page>
            ...
            />
            <h2 className="font-display text-3xl">Past books</h2>
            <p className="text-sm text-ink/70">
                Finished reads, the group’s rating, and notes from each meeting.
            </p>

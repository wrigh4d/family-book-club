...
import {changeCurrentBook, currentHistoryBook, rateCurrentBook, resolveCurrentBook, savePersonalNote} from '../lib/store'
                ...
                <>
                    ...
                    <div>
                        ...
                        <TextArea
                            value={note}
                            onChange={(event) =>
                                setDraft({bookId: currentId, text: event.target.value})
                            }
    ...
    return (
        <div className="flex flex-col gap-4">
            <p className="text-sm text-ink/70">
                This book was never finished. Replacing it deletes ratings, notes, and every other
                record of it.
            </p>
            {shortlist.length > 0 ? (
                <div>
